...
func (x *GetProductData) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetProductData) ProtoMessage() {}

func (x *GetProductData) ProtoReflect() protoreflect.Message {
	mi := &file_pkg_product_pb_product_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetProductData.ProtoReflect.Descriptor instead.
func (*GetProductData) Descriptor() ([]byte, []int) {
	return file_pkg_product_pb_product_proto_rawDescGZIP(), []int{2}
}

func (x *GetProductData) GetId() int64 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *GetProductData) GetName() string {
	if x != nil {
		return x.Name
	}
	return ""
...
func (x *GetProductData) GetSku() string {
	if x != nil {
		return x.Sku
	}
	return ""
...
func (x *GetProductData) GetStock() int64 {
	if x != nil {
		return x.Stock
	}
	return 0
...
func (x *GetProductData) GetPrice() int64 {
	if x != nil {
		return x.Price
	}
	return 0
...
type GetProductResponse struct {
	...
	Status int64           `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Error  string          `protobuf:"bytes,2,opt,name=error,proto3" json:"error,omitempty"`
	Data   *GetProductData `protobuf:"bytes,3,opt,name=data,proto3" json:"data,omitempty"`
}
...
func (x *GetProductResponse) GetData() *GetProductData {
	if x != nil {
		return x.Data
	}
	return nil
...
var file_pkg_product_pb_product_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x22, 0x72, 0x0a, 0x0e, 0x47, 0x65, 0x74, 0x50,
	...
	0x05, 0x20, 0x01, 0x28, 0x03, 0x52, 0x05, 0x70, 0x72, 0x69, 0x63, 0x65, 0x22, 0x23, 0x0a, 0x11,
	0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	0x74, 0x12, 0x0e, 0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x03, 0x52, 0x02, 0x69,
	0x64, 0x22, 0x6f, 0x0a, 0x12, 0x47, 0x65, 0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x52,
	...
	0x01, 0x28, 0x0b, 0x32, 0x17, 0x2e, 0x70, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x2e, 0x47, 0x65,
	0x74, 0x50, 0x72, 0x6f, 0x64, 0x75, 0x63, 0x74, 0x44, 0x61, 0x74, 0x61, 0x52, 0x04, 0x64, 0x61,
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x05, 0x65, 0x72, 0x72, 0x6f, 0x72, 0x32, 0xfd, 0x01, 0x0a, 0x0e,
...
var file_pkg_product_pb_product_proto_goTypes = []interface{}{
	...
	(*GetProductData)(nil),        // 2: product.GetProductData
...
var file_pkg_product_pb_product_proto_depIdxs = []int32{
	2, // 0: product.GetProductResponse.data:type_name -> product.GetProductData
